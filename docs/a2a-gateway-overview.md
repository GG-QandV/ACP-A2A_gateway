...
**Source:** `/home/gg/projects/AGENTS/ACP-A2A_gateway` (repo)
**Host:** `89.58.12.118`, service `acp-gateway`, domain `agentmesh-labs.mnemostroma.com`
...
```json
{
  ...
  "description": null,
  "version": "1",
  "url": "https://agentmesh-labs.mnemostroma.com/agents/hermes/rpc",
