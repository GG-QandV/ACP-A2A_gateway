# Известные ограничения driver-a2a-client (ТЗ: docs/SPEC-a2a-dialects-gateway-adapter-ru.md)


> **Язык:** русский · [English version](./KNOWN_LIMITATIONS.md)
...
`agent-connector/TECH_DEBT-ru.md`.
