...
## 9. Specification: correcting/refactoring the products to the strategy
...
> The detailed unified specification lives in `docs/SPEC-a2a-dialects-gateway-adapter.md` (Section 1 — gateway, Section 2 — adapter, Section 3 — common dialect probe).
